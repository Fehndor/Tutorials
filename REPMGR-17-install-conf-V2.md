...
postgres ALL=(ALL): /usr/bin/systemctl start postgresql-17.service, /usr/bin/systemctl stop postgresql-17.service, /usr/bin/systemctl restart postgresql-17.service, /usr/bin/systemctl reload postgresql-17.service, /usr/bin/systemctl status postgresql-17.service
